...
imgfile = 'spam.png'
fname = 'seminar'
row = { 'date': date, 'time':time, 'speaker':speaker, 'url' : url,	\
    'affiliation' : affiliation, 'title' : title, 'bio' : bio,  \
    'abstract' : abstract, 'imgfile' : imgfile, 'location' :location, \
    'zoom' : zoom,	'connected-papers' : related }
